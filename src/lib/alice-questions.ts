...
const daCarreQuestions: MCQQuestion[] = [
  ...
  { id: 'da_mc02', text: 'Quel drôle d\'animal familier est Gumball dans la série animée ?', answers: ['Un chien', 'Un chat bleu', 'Un lapin', 'Un poisson jaune'], correct: 1, category: 'Dessins animés & Manga', type: 'multiple-choice' }, // Waited, what was original? Un chat!
  ...
  { id: 'da_mc19', text: 'Quelle est la véritable identité civile du super-héros Chat Noir dans Miraculous ?', answers: ['Marin', 'Adrien Agreste', 'Luka', 'Nino'], correct: 1, category: 'Dessins animés & Manga', type: 'multiple-choice' },
  ...
  { id: 'da_mc25', text: 'Dans Dragon Ball Z, qui est le guerrier venu du futur pour avertir Goku ?', answers: ['Gohan adulte', 'Trunks (fils de Vegeta)', 'Goten', 'Broly'], correct: 1, category: 'Dessins animés & Manga', type: 'multiple-choice' },
...
const daCashQuestions: CashAnswerQuestion[] = [
  ...
  { id: 'da_ca06', text: 'Quel mystique artefact cherchent ardemment les frères Elric pour retrouver leurs corps ?', acceptedAnswers: ['La Pierre Philosophale', 'Pierre Philosophale'], category: 'Dessins animés & Manga', type: 'cash-answer' },
  ...
  { id: 'da_ca13', text: 'L\'appellation authentique donnée aux immenses sabres des Shinigamis dans Bleach ?', acceptedAnswers: ['Zanpakutō', 'Zanpakuto'], category: 'Dessins animés & Manga', type: 'cash-answer' },
  ...
  { id: 'da_ca19', text: 'Le nom du pauvre brillant chien de Gadget qui s\'inquiète en permanence pour lui ?', acceptedAnswers: ['Finot'], category: 'Dessins animés & Manga', type: 'cash-answer' },
  ...
  { id: 'da_ca21', text: 'Comment se régalent Sammy et son chien afin de trouver le courage des enquêtes ?', acceptedAnswers: ['Scooby-Snacks', 'Des croquettes Scooby'], category: 'Dessins animés & Manga', type: 'cash-answer' },
  ...
  { id: 'da_ca27', text: 'Quel doux prénom porte la jeune officielle fiancée martialiste de Ranma dans l\'histoire ?', acceptedAnswers: ['Akane', 'Akane Tendo', 'Adeline (En VF)'], category: 'Dessins animés & Manga', type: 'cash-answer' },
  ...
  { id: 'da_ca29', text: 'Dans le Far-West légendaire des illustres bandes dessinées, quel tireur a un cheval appelé Jolly Jumper ?', acceptedAnswers: ['Lucky Luke'], category: 'Dessins animés & Manga', type: 'cash-answer' },
...
const jvCarreQuestions: MCQQuestion[] = [
  ...
  { id: 'jv_mc02', text: 'À quelle espèce animale appartient le très vénal Tom Nook dans Animal Crossing ?', answers: ['Rat', 'Raton laveur', 'Tanuki (Sorte de raton laveur japonais)', 'Chat'], correct: 2, category: 'Jeux Vidéo', type: 'multiple-choice' },
  ...
  { id: 'jv_mc12', text: 'Comment s\'écrit et s\'appelle la douce princesse des étoiles dans Super Mario Galaxy ?', answers: ['Peach', 'Daisy', 'Harmonie (Rosalina)', 'Zelda'], correct: 2, category: 'Jeux Vidéo', type: 'multiple-choice' },
...
const jvCashQuestions: CashAnswerQuestion[] = [
  ...
  { id: 'jv_ca07', text: 'Lorsqu\'on jouait à "Duck Hunt" jadis, avec quel pistolet en plastique pointions-nous bêtement l\'écran de téléviseur ?', acceptedAnswers: ['Le NES Zapper', 'Zapper', 'Le pistolet de la NES', 'pistolet nes', 'NES Zapper'], category: 'Jeux Vidéo', type: 'cash-answer' },
  ...
  { id: 'jv_ca10', text: 'Grâce à quel étrange arceau flexible, s\'accompagnant d\'un Joy-Con, faites-vous suer tout votre salon avec Ring Fit Adventure ?', acceptedAnswers: ['Le Ring-Con', 'Ring-Con', 'Le cerceau', 'L\'anneau'], category: 'Jeux Vidéo', type: 'cash-answer' },
  ...
  { id: 'jv_ca23', text: 'Avec ses friandises explosives et d\'infatigables sollicitations colorées, ce brillant casse-tête est un rouleau compresseur de micro-transactions mobiles. De qui s\'agit-il ?', acceptedAnswers: ['Candy Crush', 'Candy Crush Saga'], category: 'Jeux Vidéo', type: 'cash-answer' },
  ...
  { id: 'jv_ca28', text: 'Avec sa formidable paire d’écrans innovants superposée l\'un dessus, l\'autre délicatement tactile dessous, de quelle légendaire console nomade best-seller mondiale et charismatique de Nintendo s\'agit-il ?', acceptedAnswers: ['Nintendo DS', 'NDS', 'La DS'], category: 'Jeux Vidéo', type: 'cash-answer' },
  ...
  { id: 'jv_ca30', text: 'Avant un immense carnage par pistolet-mitrailleur fluo avec ses centaines d\'adolescents, quel brillant phénomène vidéoludique compétitif démarre avec d\'hilarants joueurs largués des airs par leur mythologique car en lévitation, le rutilant "Bus de Combat" ?', acceptedAnswers: ['Fortnite', 'Fortnite Battle Royale'], category: 'Jeux Vidéo', type: 'cash-answer' },
];
...
const pcCarreQuestions: MCQQuestion[] = [
  ...
  { id: 'pc_mc03', text: 'Quel étrange prénom (un chiffre) porte la puissante jeune fille télépathe de Stranger Things ?', answers: ['Onze (Eleven)', 'Douze', 'Neuf', 'Dix'], correct: 0, category: 'Pop Culture', type: 'multiple-choice' },
  ...
  { id: 'pc_mc09', text: 'Dans le film Les Indestructibles, la jeune Violette Parr possède quel super-pouvoir défensif ?', answers: ['Créer du Feu', 'La super Vitesse', 'L\'invisibilité et les champs de force', 'La Force surhumaine'], correct: 2, category: 'Pop Culture', type: 'multiple-choice' },
  ...
  { id: 'pc_mc18', text: 'Quel super-héros Marvel, simple humain, fait pleuvoir ses inratables flèches sur ses cibles ?', answers: ['Hawkeye (Œil de faucon)', 'Iron Man', 'Hulk', 'Vision'], correct: 0, category: 'Pop Culture', type: 'multiple-choice' },
...
const pcCashQuestions: CashAnswerQuestion[] = [
  { id: 'pc_ca01', text: 'Dans le célébrissime film Retour vers le Futur, à combien de "miles à l\'heure" la DeLorean doit-elle être propulsée pour déchirer l\'espace temporel ?', acceptedAnswers: ['88', '88 miles à l\'heure', '88 miles', '88 mph'], category: 'Pop Culture', type: 'cash-answer' },
  ...
  { id: 'pc_ca05', text: 'Que chaparde inopinément Marty McFly d\'une main d\'apprenti à des gamins effrayés, cette étrange planche futuriste en lévitation d\'une rare merveille rose de Retour vers le Futur 2 ?', acceptedAnswers: ["L'Hoverboard", 'Hoverboard', 'Le skate volant'], category: 'Pop Culture', type: 'cash-answer' },
  ...
  { id: 'pc_ca21', text: 'Pour le compte des puissants commandements antiques, sous un soleil écrasant, un coffre doré sacré, destructeur d\'occultistes nazis est chassé... Quel sombre et saint reliquat de Moïse Indiana Jones retrouve-t-il dans les Sables ? (Le nom complet de L\'Arche...)', acceptedAnswers: ["L'Arche d'Alliance", "Arche d'Alliance"], category: 'Pop Culture', type: 'cash-answer' },
  ...
  { id: 'pc_ca30', text: 'Par la force du Walther PPK... Costard parfait, flegme, vodkas au shaker en main et martinis sous l\'allégeance meurtrière discrète d\'une couronne anglaise au service caché du MI6 par l\'matricule d\'indicatif secret 007. L\'univers salue...', acceptedAnswers: ['James Bond', 'Bond', 'Bond, James Bond'], category: 'Pop Culture', type: 'cash-answer' },
];
