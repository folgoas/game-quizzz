...
const mangaSpeed: MCQQuestion[] = [
  ...
  { id: 'mg_s10', text: "Quel fruit du démon a mangé Monkey D. Luffy ?", answers: ["Le Ténèbres", "L'Élastique (Gomu Gomu)", "Le Feu", "La Glace"], correct: 1, category: 'Mangas', type: 'speed-choice' },
  ...
  { id: 'mg_s13', text: "Quelle est la couleur des cheveux du Super Saiyan classique ?", answers: ["Bleu", "Noir", "Rouge", "Doré / Jaune"], correct: 3, category: 'Mangas', type: 'speed-choice' },
  ...
  { id: 'mg_s19', text: "Quel animal est Happy dans Fairy Tail ?", answers: ["Un chat volant bleu", "Un chien", "Un dragon rouge", "Un singe"], correct: 0, category: 'Mangas', type: 'speed-choice' },
...
const mangaMcq: MCQQuestion[] = [
  { id: 'mg_m1', text: "Dans One Piece, quel est l'équipage de Trafalgar Law ?", answers: ["L'Équipage du Cœur (Heart Pirates)", "Kidd Pirates", "Chapeau de Paille", "Spade Pirates"], correct: 0, category: 'Mangas', type: 'multiple-choice' },
  ...
  { id: 'mg_m8', text: "Quel est le nom de l'alter sans pouvoir de Izuku Midoriya (av. le One For All) ?", answers: ["Zéro", "Il n'avait pas d'alter", "Transparence", "Force"], correct: 1, category: 'Mangas', type: 'multiple-choice' },
  ...
  { id: 'mg_m13', text: "Quel animal mystique scelle le destin du Japon dans Princesse Mononoké ?", answers: ["Un dragon", "Un cerf (L'Esprit de la forêt)", "Une araignée", "Un poisson géant"], correct: 1, category: 'Mangas', type: 'multiple-choice' },
  ...
  { id: 'mg_m20', text: "Comment s'appelle le personnage principal chauve avec une cape jaune ?", answers: ["Mob", "Krillin", "Saitama (One Punch Man)", "Ikkaku"], correct: 2, category: 'Mangas', type: 'multiple-choice' }
];
